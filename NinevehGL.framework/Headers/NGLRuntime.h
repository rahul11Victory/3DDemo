 ...
 *                      - The current Class.
 */
#define nglLog()			NSLog(@"%@ :: %@", [NSThread currentThread], NSStringFromSelector(_cmd))
...
/*!
 *					Represents the resize time of the current device.
 *
 *	@result			A float indicating the resize time of the current device.
 */
#define nglResizeTime()		0.3f