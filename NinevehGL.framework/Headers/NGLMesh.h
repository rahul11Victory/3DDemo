...
@class NGLMeshElements, NGLCamera;
 ...
 *
 *					<b>IMPORTANT</b>: You should not change the multithreading mode while loading.
 *
 *	@see			NGLMeshDelegate
 */
@interface NGLMesh : NGLObject3D <NGLCoreTimer>
{
@private
	// Matrices
	NGLmat4					_mvpMatrix;
 ...
 *
 *					This method should be called after a change in materials, shaders or surfaces.
 *					Calls to this method while a loding is happening will be ignored.
 */
