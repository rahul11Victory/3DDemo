...
/*!
 *					Defines a target to look at. At every render cycle, this object will perform a
 *					lookAt routine with the specified target. The lookAt affects rotations in X and Y
 ...
 *
 *					This method has the same bahavior as <code>#lookAtTarget:#</code> method, but instead
